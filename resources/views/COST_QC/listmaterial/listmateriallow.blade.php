        ...
        <table class="table table-bordered text-nowrap " id="listlow" style="width: 100%">
            ...
            <tbody>
                @foreach ($baranglows as $baranglow)
                    <tr>
                        <td class="text-end">
                            ...
                            <a href="{{ route('Barang.edit', $baranglow->id) }}" class="btn btn-primary btn-sm"
                                title="Edit Material"><i class="fa fa-pen"></i></a>
                            <a href="{{ route('tambah', $baranglow->id) }}" class="btn btn-warning btn-sm"
                                title="Tambah Material"><i class="fa fa-cart-plus"></i></a>
              ...
              <input type="submit" value="Delete" class="btn btn-danger btn-sm ">
                        ...
                        <td>{{ $baranglow->Type_of_Budget }}</td>
