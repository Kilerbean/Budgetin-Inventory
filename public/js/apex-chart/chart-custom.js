...
var chartalldepartment = new ApexCharts(
    document.querySelector("#all-department-lup-status"),
    alldepartmentstatus
);
chartalldepartment.render();
...
var luptypedata = {
    ...
    colors:['#02C239', '#0268C2', '#222222', '#717171', '#e2c636','#02C2BC','#028EC2','#5902C2','#9C02C2','#C202B1',
            '#C20251','#39C202','#C2BC02','#C26202','#C23302','#C21902','#02C26E','#0265C2','#0205C2','#56C202']
}

var luptypechart = new ApexCharts(
    document.querySelector("#all-lup-type"),
    luptypedata
);
luptypechart.render();
...
var hitmissedstatus = {
    ...
    {
        name: 'Hit with Extend',
        data: totalhitextended
    },
    {
        name: 'TOTAL MISSED',
        data: totalmissed
    ...
    {
        name: 'Missed with Extend',
        data: totalmissedextended
    },],
    xaxis: {
        categories: departments,
    },
    colors:['#02C239','#0029F4','#F4000B','#C23302'],
    fill: {
        type: "gradient",
        gradient: {
          shadeIntensity: 0.1,
...
var charthitmissed = new ApexCharts(
    document.querySelector("#all-department-lup-hit"),
    hitmissedstatus
);
charthitmissed.render();
